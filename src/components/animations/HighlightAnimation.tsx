          ...
          <span className={`relative ${step >= 1 ? 'bg-[#B49AFF]/30 dark:bg-[#C2ACFF]/30 rounded px-1' : ''}`}>
            ...
            {step >= 2 && (
              <motion.span
                ...
                className="absolute -top-1 -right-2 w-4 h-4 bg-gradient-to-r from-[#8A4FFF] to-[#4FB0FF] dark:from-[#9F6AFF] dark:to-[#52C5FF] rounded-full flex items-center justify-center cursor-pointer z-10"
              >
